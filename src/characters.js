export const CHARACTERS = [
    ...
    },
    {
        ...
        ability: "Lucky Kid",
        stats: ["Speed: −5%", "Rare chance: +15%", "Epic: +10% · Legendary: +5%"],
    ...
    },
    {
        ...
        ability: "Speedy Kid",
        stats: ["Speed: 7.84 tiles/sec (+12%)", "Head Starts are 25% weaker", "Speed rewards stack normally"],
        speedMultiplier: 1.12,
        headStartMultiplier: 0.75,
